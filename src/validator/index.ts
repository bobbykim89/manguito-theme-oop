...
import type { ClassType, InputType } from "../mcl-theme";
...
export class ValidateMclClass<T extends ClassType> {
  ...
  public validateColorType(): boolean {
    const validatorRe =
  ...
  public validateSpaceType(): boolean {
  ...
  public validateHeadingTextSizeType(): boolean {
